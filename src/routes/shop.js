...
router.get("/product/:productId", sanitizeMiddleware, productController.getProduct);
...
router.post("/product/:productId", sanitizeMiddleware, productController.postComment);

router.get("/search", sanitizeMiddleware, productController.getSearch);

router.get("/shopping_cart", productController.getCart);

router.get("/add-to-cart/:productId", sanitizeMiddleware, productController.addToCart);
...
router.get("/delete-item/:productId", sanitizeMiddleware, productController.getDeleteItem);
